...
var UUID = /** @class */ (function (_super) {
    ...
    function UUID(input) {
        ...
        if (input == null) {
            ...
            throw new error_1.BSONTypeError('Argument passed in UUID constructor must be a UUID, a 16 byte Buffer or a 32/36 character hex string (dashes excluded/included, format: xxxxxxxx-xxxx-xxxx-xxxx-***REMOVED***xx).');
        }
