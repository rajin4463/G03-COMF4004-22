...
var uuidHexStringToBuffer = function (hexString) {
    if (!(0, exports.uuidValidateString)(hexString)) {
        throw new error_1.BSONTypeError('UUID string representations must be a 32 or 36 character hex string (dashes excluded/included). Format: "***REMOVED******REMOVED******REMOVED***xx" or "xxxxxxxx-xxxx-xxxx-xxxx-***REMOVED***xx".');
    }
