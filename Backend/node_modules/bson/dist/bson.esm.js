...
var uuidHexStringToBuffer = function (hexString) {
    if (!uuidValidateString(hexString)) {
        throw new BSONTypeError('UUID string representations must be a 32 or 36 character hex string (dashes excluded/included). Format: "***REMOVED******REMOVED******REMOVED***xx" or "xxxxxxxx-xxxx-xxxx-xxxx-***REMOVED***xx".');
    }
...
var UUID = /** @class */ (function (_super) {
    ...
    function UUID(input) {
        ...
        if (input == null) {
            ...
            throw new BSONTypeError('Argument passed in UUID constructor must be a UUID, a 16 byte Buffer or a 32/36 character hex string (dashes excluded/included, format: xxxxxxxx-xxxx-xxxx-xxxx-***REMOVED***xx).');
        }
     ...
     * A 36 character (dashes included) hex string in the format: xxxxxxxx-xxxx-xxxx-xxxx-***REMOVED***xx
     */
