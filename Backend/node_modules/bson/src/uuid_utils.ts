...
export const uuidHexStringToBuffer = (hexString: string): Buffer => {
  if (!uuidValidateString(hexString)) {
    throw new BSONTypeError(
      'UUID string representations must be a 32 or 36 character hex string (dashes excluded/included). Format: "***REMOVED******REMOVED******REMOVED***xx" or "xxxxxxxx-xxxx-xxxx-xxxx-***REMOVED***xx".'
    );
  }
